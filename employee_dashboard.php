...
require_once __DIR__ . '/employee_actions.php';
    ...
    <div class="flex h-screen bg-gray-200">
        ...
        <div id="sidebar" class="w-64 bg-gray-800 text-gray-300 flex-shrink-0 flex flex-col">
            ...
            <nav class="flex-1 px-4 py-4 space-y-2 sidebar-scroll overflow-y-auto">
                ...
                <a href="#" onclick="showTab('my-requests')" class="tab-item flex items-center px-4 py-2 rounded-md hover:bg-gray-700">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    async function loadMyAssets() {
        ...
        const res = await apiRequest('employee_dashboard.php', 'get_my_assets');
    ...
    async function loadAvailableAssets() {
        ...
        const res = await apiRequest('employee_dashboard.php', 'get_borrowable_assets');
        loading.style.display = 'none';
    ...
    async function loadMyRequests() {
        ...
        const res = await apiRequest('employee_dashboard.php', 'get_asset_requests');
        loading.style.display = 'none';
    ...
    document.getElementById('returnAssetForm').addEventListener('submit', async function(e) {
        ...
        const res = await apiRequest('employee_dashboard.php', 'return_asset', data);
        if (res.success) {
    ...
    window.requestSpecificAsset = async function(assetId) {
        ...
        if (formValues) {
            ...
            const res = await apiRequest('employee_dashboard.php', 'request_specific_asset', {
                asset_id: assetId,
                purpose: purpose,
