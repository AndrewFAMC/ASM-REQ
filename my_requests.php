    ...
    <div class="min-h-screen flex">
        ...
        <div id="sidebar" class="w-64 bg-gray-800 text-gray-300 flex-shrink-0 flex flex-col">
            ...
            <nav class="flex-1 px-4 py-4 space-y-2 sidebar-scroll overflow-y-auto">
                <a href="employee_dashboard.php" class="flex items-center px-4 py-2 rounded-md hover:bg-gray-700 text-gray-300">
                    <i class="fas fa-home w-6"></i><span>Dashboard</span>
                </a>
                <a href="my_requests.php" class="flex items-center px-4 py-2 rounded-md bg-gray-700 text-white">
                    <i class="fas fa-paper-plane w-6"></i><span>My Requests</span>
                </a>
                <a href="request_asset.php" class="flex items-center px-4 py-2 rounded-md hover:bg-gray-700 text-gray-300">
                ...
                <a href="notification_preferences.php" class="flex items-center px-4 py-2 rounded-md hover:bg-gray-700 text-gray-300">
                    <i class="fas fa-bell w-6"></i><span>Notifications</span>
                </a>
                <a href="profile.php" class="flex items-center px-4 py-2 rounded-md hover:bg-gray-700 text-gray-300">
                    <i class="fas fa-user-circle w-6"></i><span>Profile</span>
                </a>
            </nav>
        </div>
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <?php if (empty($requests)): ?>
                <div class="bg-white rounded-lg shadow-sm py-16 text-center">
                    ...
                    <a href="employee_dashboard.php" class="mt-4 inline-block bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg">
                        Browse Assets
                    </a>
                </div>
            <?php else: ?>
